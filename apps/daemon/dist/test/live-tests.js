...
async function runTests() {
    ...
    const escapeAttempt = await request('GET', '/fs/tree?projectId=../projects-evil', { Authorization: `Bearer ${token}` });
    ...
    const revokeWithAuth = await request('POST', '/auth/revoke', { Authorization: `Bearer ${token}` });
