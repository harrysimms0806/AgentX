...
const validCheck = sandbox.validatePath('test-project', 'file.txt');
...
const traversalCheck = sandbox.validatePath('../projects-evil', 'file.txt');
...
const slashCheck = sandbox.validatePath('../other', 'file.txt');
...
const invalidCheck = sandbox.validatePath('test@project', 'file.txt');
...
const prefixCheck = sandbox.validatePath('projects-evil', 'file.txt');
...
const escapeCheck = sandbox.validatePath('test-project', '../../etc/passwd');
